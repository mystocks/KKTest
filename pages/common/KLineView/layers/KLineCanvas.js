...
KLineCanvas.prototype.initLayers = function () {
  if (this.mIsInit == false) {
    ...
    this.kLineStackLayer.addLayer(this.kLineLayer);//绘制K线
    this.kLineStackLayer.addLayer(this.ma5Layer);//绘制5日均线
    this.kLineStackLayer.addLayer(this.ma10Layer);//绘制10日均线
    this.kLineStackLayer.addLayer(this.ma20Layer);//绘制13日均线
